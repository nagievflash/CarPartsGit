    ...
    <x-slot name="header">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Import inventory from csv/txt files</h3>
                <p class="text-subtitle text-muted">This is the Inventory import page.</p>
            </div>
...
{{--                 <div class="form-field mt-3">
                    ...
                    <div class="form-field mt-4">
                        <button type="submit" class="btn btn-success form-submit">Send inventory</button>
                    </div>
                </form>
            </div>
