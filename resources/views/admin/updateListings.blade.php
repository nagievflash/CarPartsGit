<x-app-layout>
    <x-slot name="header">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Update Ebay Listings from csv/txt files</h3>
                <p class="text-subtitle text-muted">This is the Update Ebay Listings page.</p>
            </div>
    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <form action="/admin/import/updateListings" method="POST" enctype="multipart/form-data">
                    @csrf
